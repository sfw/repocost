  ...
  if (!/^[\w.-]+$/.test(owner) || !/^[\w.-]+$/.test(repo)) {
    return new ImageResponse(
      (
        ...
        >
          <div style={{ fontSize: "48px", fontWeight: 800, marginBottom: "16px" }}>repocost</div>
      ...
      (
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: "12px", marginBottom: "8px" }}>
            <div style={{ fontSize: "84px", fontWeight: 800, letterSpacing: "-3px", lineHeight: 1, color: "#fff" }}>
              {bigNum}
            </div>
            {bigUnit && (
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            {topLangs.map((l) => (
              ...
              >
                ...
                <span style={{ color: "#999" }}>{l.name}</span>
                <span style={{ color: "#ccc", fontWeight: 700 }}>{fmtCost(l.cost)}</span>
              </div>
            ))}
          </div>
